...
def test_teaching_default() -> None:
...
def test_compact_write_none(tmp_path: Path) -> None:
...
def test_teaching_write(tmp_path: Path) -> None:
...
def test_member_choice_norm() -> None:
...
def test_dialect_rejects_int() -> None:
